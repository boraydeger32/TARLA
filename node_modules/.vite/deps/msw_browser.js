import {
  ...
  toReadonlyArray,
  until
} from "./chunk-5WJVOIKU.js";
import {
  __privateAdd,
  __privateGet
} from "./chunk-PTBI3EWP.js";

// node_modules/.pnpm/msw@2.13.4_@types+node@25.6.0/node_modules/msw/lib/core/experimental/frames/network-frame.mjs
...
// node_modules/.pnpm/msw@2.13.4_@types+node@25.6.0/node_modules/msw/lib/core/experimental/sources/network-source.mjs
...
// node_modules/.pnpm/msw@2.13.4_@types+node@25.6.0/node_modules/msw/lib/core/experimental/request-utils.mjs
var REQUEST_INTENTION_HEADER_NAME = "x-msw-intention";
var RequestIntention = ((RequestIntention2) => {
...
// node_modules/.pnpm/msw@2.13.4_@types+node@25.6.0/node_modules/msw/lib/core/experimental/frames/http-frame.mjs
...
// node_modules/.pnpm/msw@2.13.4_@types+node@25.6.0/node_modules/msw/lib/core/experimental/on-unhandled-frame.mjs
...
// node_modules/.pnpm/msw@2.13.4_@types+node@25.6.0/node_modules/msw/lib/core/experimental/define-network.mjs
...
var NetworkReadyState = ((NetworkReadyState2) => {
...
// node_modules/.pnpm/@mswjs+interceptors@0.41.4/node_modules/@mswjs/interceptors/lib/browser/hasConfigurableGlobal-npXitu1-.mjs
...
// node_modules/.pnpm/@mswjs+interceptors@0.41.4/node_modules/@mswjs/interceptors/lib/browser/interceptors/WebSocket/index.mjs
...
var _a;
var WebSocketOverride = (_a = class extends EventTarget {
...
}, _a.CONNECTING = 0, _a.OPEN = 1, _a.CLOSING = 2, _a.CLOSED = 3, _a);
...
var _a2;
var WebSocketInterceptor = (_a2 = class extends Interceptor {
  constructor() {
    super(_a2.symbol);
  }
  checkEnvironment() {
...
}, _a2.symbol = /* @__PURE__ */ Symbol("websocket"), _a2);

// node_modules/.pnpm/msw@2.13.4_@types+node@25.6.0/node_modules/msw/lib/core/experimental/frames/websocket-frame.mjs
...
// node_modules/.pnpm/msw@2.13.4_@types+node@25.6.0/node_modules/msw/lib/core/experimental/sources/interceptor-source.mjs
...
// node_modules/.pnpm/msw@2.13.4_@types+node@25.6.0/node_modules/msw/lib/core/experimental/compat.mjs
...
// node_modules/.pnpm/msw@2.13.4_@types+node@25.6.0/node_modules/msw/lib/core/utils/toResponseInit.mjs
...
// node_modules/.pnpm/msw@2.13.4_@types+node@25.6.0/node_modules/msw/lib/browser/index.mjs
...
var WebSocketClientConnection2 = class {
  constructor(socket, transport) {
    ...
    this.transport.addEventListener("outgoing", (event) => {
      const message = bindEvent2(this.socket, new CancelableMessageEvent2("message", {
        data: event.data,
        origin: event.origin,
        cancelable: true
      }));
      this[kEmitter$12].dispatchEvent(message);
      if (message.defaultPrevented) event.preventDefault();
    });
    this.transport.addEventListener("close", (event) => {
...
var _a3;
var WebSocketOverride2 = (_a3 = class extends EventTarget {
  constructor(url, protocols) {
    super();
    this.CONNECTING = 0;
    this.OPEN = 1;
    ...
    this.readyState = this.CONNECTING;
    this.bufferedAmount = 0;
    this[kPassthroughPromise2] = new DeferredPromise2();
    queueMicrotask(async () => {
...
}, _a3.CONNECTING = 0, _a3.OPEN = 1, _a3.CLOSING = 2, _a3.CLOSED = 3, _a3);
...
var WebSocketServerConnection2 = class {
  ...
  */
  connect() {
    ...
    realWebSocket.binaryType = this.client.binaryType;
    realWebSocket.addEventListener("open", (event) => {
      this[kEmitter2].dispatchEvent(bindEvent2(this.realWebSocket, new Event("open", event)));
    }, { once: true });
    realWebSocket.addEventListener("message", (event) => {
  ...
  */
  close() {
    ...
    realWebSocket.close();
    queueMicrotask(() => {
      this[kEmitter2].dispatchEvent(bindEvent2(this.realWebSocket, new CancelableCloseEvent2("close", {
        code: 1e3,
        cancelable: true
      })));
    });
...
var _a4;
var WebSocketInterceptor2 = (_a4 = class extends Interceptor2 {
  constructor() {
    super(_a4.symbol);
  }
  checkEnvironment() {
    ...
    const WebSocketProxy = new Proxy(globalThis.WebSocket, { construct: (target, args, newTarget) => {
      ...
      queueMicrotask(async () => {
        try {
          ...
          if (error2 instanceof Error) {
            socket.dispatchEvent(new Event("error"));
            if (socket.readyState !== WebSocket.CLOSING && socket.readyState !== WebSocket.CLOSED) socket[kClose2](1011, error2.message, false);
            console.error(error2);
          }
        }
      });
...
}, _a4.symbol = /* @__PURE__ */ Symbol("websocket"), _a4);
...
var IS_PATCHED_MODULE = /* @__PURE__ */ Symbol("isPatchedModule");
...
var _RequestController2_instances, handled_get, _a5;
var RequestController = (_a5 = class {
  constructor(request, source) {
    __privateAdd(this, _RequestController2_instances);
    this.request = request;
    this.source = source;
    this.readyState = _a5.PENDING;
  ...
  */
  async passthrough() {
    invariant2.as(InterceptorError, this.readyState === _a5.PENDING, 'Failed to passthrough the "%s %s" request: the request has already been handled', this.request.method, this.request.url);
    this.readyState = _a5.PASSTHROUGH;
    await this.source.passthrough();
    __privateGet(this, _RequestController2_instances, handled_get).resolve();
  }
  /**
  ...
  */
  respondWith(response) {
    invariant2.as(InterceptorError, this.readyState === _a5.PENDING, 'Failed to respond to the "%s %s" request with "%d %s": the request has already been handled (%d)', this.request.method, this.request.url, response.status, response.statusText || "OK", this.readyState);
    this.readyState = _a5.RESPONSE;
    __privateGet(this, _RequestController2_instances, handled_get).resolve();
  ...
  */
  errorWith(reason) {
    invariant2.as(InterceptorError, this.readyState === _a5.PENDING, 'Failed to error the "%s %s" request with "%s": the request has already been handled (%d)', this.request.method, this.request.url, reason?.toString(), this.readyState);
    this.readyState = _a5.ERROR;
    this.source.errorWith(reason);
    __privateGet(this, _RequestController2_instances, handled_get).resolve();
  }
}, _RequestController2_instances = new WeakSet(), handled_get = function() {
  return this.handled;
}, _a5.PENDING = 0, _a5.PASSTHROUGH = 1, _a5.RESPONSE = 2, _a5.ERROR = 3, _a5);
...
var _a6;
var FetchResponse = (_a6 = class extends Response {
  static isConfigurableStatusCode(status) {
    return status >= 200 && status <= 599;
  }
  static isRedirectResponse(status) {
    return _a6.STATUS_CODES_WITH_REDIRECT.includes(status);
  }
  /**
  ...
  */
  static isResponseWithBody(status) {
    return !_a6.STATUS_CODES_WITHOUT_BODY.includes(status);
  }
  ...
  */
  ...
  constructor(body, init = {}) {
    ...
    const safeStatus = _a6.isConfigurableStatusCode(status) ? status : 200;
    const finalBody = _a6.isResponseWithBody(status) ? body : null;
    super(finalBody, {
      status: safeStatus,
    ...
    _a6.setUrl(init.url, this);
  }
}, _a6.STATUS_CODES_WITHOUT_BODY = [
  101,
  103,
  204,
  205,
  304
], _a6.STATUS_CODES_WITH_REDIRECT = [
  301,
  302,
  303,
  307,
...
function createNetworkError(cause) {
  return Object.assign(new TypeError("Failed to fetch"), { cause });
}
...
var _a7;
var FetchInterceptor = (_a7 = class extends Interceptor2 {
  constructor() {
    super(_a7.symbol);
  }
  checkEnvironment() {
...
}, _a7.symbol = /* @__PURE__ */ Symbol("fetch"), _a7);
...
var _a8;
var XMLHttpRequestInterceptor = (_a8 = class extends Interceptor2 {
  constructor() {
    super(_a8.interceptorSymbol);
  }
  checkEnvironment() {
...
}, _a8.interceptorSymbol = /* @__PURE__ */ Symbol("xhr"), _a8);
      ...
      network.configure({
        sources: [
          ...
          new InterceptorSource({
            interceptors: [new WebSocketInterceptor2()]
          })
        ],
